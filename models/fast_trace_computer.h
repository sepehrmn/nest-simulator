...
/* BeginDocumentation
  ...
  The fast_trace_computer can also record spike times and calculate
...
inline void
fast_trace_computer::set_has_proxies( const bool hp )
{
  has_proxies_ = hp;
}

inline void
fast_trace_computer::set_local_receiver( const bool lr )
{
  local_receiver_ = lr;
}

inline void
fast_trace_computer::finalize()
{
...
#endif /* #ifndef fast_trace_computer_H */
