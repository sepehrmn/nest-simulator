...
nest::fast_trace_computer::Parameters_::Parameters_()
...
nest::fast_trace_computer::State_::State_()
{
}

void
nest::fast_trace_computer::Parameters_::get( DictionaryDatum& d ) const
{
...
nest::fast_trace_computer::Variables_::Variables_()
  : filter_block_index_( 0 )
{
}

void
nest::fast_trace_computer::init_state_( const Node& np )
{
  const fast_trace_computer& sd =
    dynamic_cast< const fast_trace_computer& >( np );
...
void
nest::fast_trace_computer::init_buffers_()
{
...
void
nest::fast_trace_computer::calibrate()
{
...
void
nest::fast_trace_computer::print_value( long sender,
  double time,
  double value )
{
...
long
nest::fast_trace_computer::filter_step_( long update_start )
{
  /**
   *
...
double
nest::fast_trace_computer::add_impulse_( long node )
{
...
double
nest::fast_trace_computer::calculate_decay_( long node,
  double to_time )
{
  B_.traces_[ node ] =
...
void nest::fast_trace_computer::determine_steps_( Time const& origin, const long from )
{
...
void
nest::fast_trace_computer::update( Time const& origin,
  const long from,
  const long to )
{
...
void
nest::fast_trace_computer::get_status( DictionaryDatum& d ) const
{
...
void
nest::fast_trace_computer::set_status( const DictionaryDatum& d )
{
  ...
  {
    LOG( M_INFO,
      "fast_trace_computer::set_status",
      String::compose(
...
void
nest::fast_trace_computer::handle( SpikeEvent& e )
{
